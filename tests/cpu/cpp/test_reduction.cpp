...
static Array arange_2d(int rows, int cols, float start = 0.0f,
                       float step = 1.0f) {
...
static Array arange_3d(int d0, int d1, int d2, float start = 0.0f,
                       float step = 1.0f) {
...
TEST_F(ReductionTest, CumSum3D) {
  Array x =
      arange_3d(2, 2, 3); // slice0: [0,1,2; 3,4,5]; slice1: [6,7,8; 9,10,11]
