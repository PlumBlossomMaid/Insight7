...
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_F32, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_F64, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_I8, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_I16, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_I32, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_I64, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_U8, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_U16, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_U32, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_U64, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_BOOL, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_C32, maximum_kernel_gpu);
REGISTER_IXUCA_KERNEL(maximum, INSIGHT_DTYPE_C64, maximum_kernel_gpu);
