...
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_F32, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_F64, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_I8, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_I16, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_I32, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_I64, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_U8, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_U16, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_U32, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_U64, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_BOOL, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(bitwise_or, INSIGHT_DTYPE_BOOL, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_C32, logical_or_kernel_gpu);
REGISTER_IXUCA_KERNEL(logical_or, INSIGHT_DTYPE_C64, logical_or_kernel_gpu);
