...
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_F32, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_F64, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_I8, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_I16, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_I32, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_I64, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_U8, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_U16, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_U32, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_U64, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_BOOL, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_C32, less_equal_kernel_gpu);
REGISTER_IXUCA_KERNEL(less_equal, INSIGHT_DTYPE_C64, less_equal_kernel_gpu);
