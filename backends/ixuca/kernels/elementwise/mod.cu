...
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_I8, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_I16, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_I32, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_I64, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_U8, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_U16, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_U32, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_U64, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_F32, mod_kernel_gpu);
REGISTER_IXUCA_KERNEL(mod, INSIGHT_DTYPE_F64, mod_kernel_gpu);
