...
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_F32, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_F64, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_I8, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_I16, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_I32, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_I64, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_U8, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_U16, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_U32, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_U64, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_BOOL, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_C32, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_C64, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_F16, sub_kernel_gpu);
REGISTER_IXUCA_KERNEL(sub, INSIGHT_DTYPE_BF16, sub_kernel_gpu);
