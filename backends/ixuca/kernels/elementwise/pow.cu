...
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_F32, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_F64, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_I8, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_I16, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_I32, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_I64, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_U8, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_U16, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_U32, pow_kernel_gpu);
REGISTER_IXUCA_KERNEL(pow, INSIGHT_DTYPE_U64, pow_kernel_gpu);
