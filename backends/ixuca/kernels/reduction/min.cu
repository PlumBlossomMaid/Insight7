...
REGISTER_IXUCA_KERNEL(min, INSIGHT_DTYPE_F32, min_kernel_gpu);
REGISTER_IXUCA_KERNEL(min, INSIGHT_DTYPE_F64, min_kernel_gpu);
REGISTER_IXUCA_KERNEL(min, INSIGHT_DTYPE_I32, min_kernel_gpu);
REGISTER_IXUCA_KERNEL(min, INSIGHT_DTYPE_I64, min_kernel_gpu);
