...
REGISTER_IXUCA_KERNEL(cumsum, INSIGHT_DTYPE_F32, cumsum_kernel_gpu);
REGISTER_IXUCA_KERNEL(cumsum, INSIGHT_DTYPE_F64, cumsum_kernel_gpu);
REGISTER_IXUCA_KERNEL(cumsum, INSIGHT_DTYPE_I32, cumsum_kernel_gpu);
REGISTER_IXUCA_KERNEL(cumsum, INSIGHT_DTYPE_I64, cumsum_kernel_gpu);
