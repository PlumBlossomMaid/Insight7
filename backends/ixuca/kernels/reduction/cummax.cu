...
REGISTER_IXUCA_KERNEL(cummax, INSIGHT_DTYPE_F32, cummax_kernel_gpu);
REGISTER_IXUCA_KERNEL(cummax, INSIGHT_DTYPE_F64, cummax_kernel_gpu);
REGISTER_IXUCA_KERNEL(cummax, INSIGHT_DTYPE_I32, cummax_kernel_gpu);
REGISTER_IXUCA_KERNEL(cummax, INSIGHT_DTYPE_I64, cummax_kernel_gpu);
