...
REGISTER_IXUCA_KERNEL(max, INSIGHT_DTYPE_F32, max_kernel_gpu);
REGISTER_IXUCA_KERNEL(max, INSIGHT_DTYPE_F64, max_kernel_gpu);
REGISTER_IXUCA_KERNEL(max, INSIGHT_DTYPE_I32, max_kernel_gpu);
REGISTER_IXUCA_KERNEL(max, INSIGHT_DTYPE_I64, max_kernel_gpu);
