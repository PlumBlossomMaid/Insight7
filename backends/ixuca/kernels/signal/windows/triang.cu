...
REGISTER_IXUCA_KERNEL(triang, INSIGHT_DTYPE_F64, triang_kernel_gpu);
REGISTER_IXUCA_KERNEL(triang, INSIGHT_DTYPE_F32, triang_kernel_gpu);
REGISTER_IXUCA_KERNEL(triang, INSIGHT_DTYPE_F16, triang_kernel_gpu);
REGISTER_IXUCA_KERNEL(triang, INSIGHT_DTYPE_BF16, triang_kernel_gpu);
