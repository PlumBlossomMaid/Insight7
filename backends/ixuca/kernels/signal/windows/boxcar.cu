...
REGISTER_IXUCA_KERNEL(boxcar, INSIGHT_DTYPE_F64, boxcar_kernel_gpu);
REGISTER_IXUCA_KERNEL(boxcar, INSIGHT_DTYPE_F32, boxcar_kernel_gpu);
REGISTER_IXUCA_KERNEL(boxcar, INSIGHT_DTYPE_F16, boxcar_kernel_gpu);
REGISTER_IXUCA_KERNEL(boxcar, INSIGHT_DTYPE_BF16, boxcar_kernel_gpu);
