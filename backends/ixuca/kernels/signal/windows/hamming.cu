...
REGISTER_IXUCA_KERNEL(hamming, INSIGHT_DTYPE_F64, hamming_kernel_gpu);
REGISTER_IXUCA_KERNEL(hamming, INSIGHT_DTYPE_F32, hamming_kernel_gpu);
REGISTER_IXUCA_KERNEL(hamming, INSIGHT_DTYPE_F16, hamming_kernel_gpu);
REGISTER_IXUCA_KERNEL(hamming, INSIGHT_DTYPE_BF16, hamming_kernel_gpu);
