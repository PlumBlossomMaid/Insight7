...
REGISTER_IXUCA_KERNEL(kaiser, INSIGHT_DTYPE_F64, kaiser_kernel_gpu);
REGISTER_IXUCA_KERNEL(kaiser, INSIGHT_DTYPE_F32, kaiser_kernel_gpu);
REGISTER_IXUCA_KERNEL(kaiser, INSIGHT_DTYPE_F16, kaiser_kernel_gpu);
REGISTER_IXUCA_KERNEL(kaiser, INSIGHT_DTYPE_BF16, kaiser_kernel_gpu);
