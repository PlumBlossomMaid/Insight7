...
REGISTER_IXUCA_KERNEL(signal_exponential, INSIGHT_DTYPE_F64,
                         signal_exponential_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_exponential, INSIGHT_DTYPE_F32,
                         signal_exponential_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_exponential, INSIGHT_DTYPE_F16,
                         signal_exponential_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_exponential, INSIGHT_DTYPE_BF16,
                         signal_exponential_kernel_gpu);
