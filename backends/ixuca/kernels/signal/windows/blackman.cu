...
REGISTER_IXUCA_KERNEL(blackman, INSIGHT_DTYPE_F64, blackman_kernel_gpu);
REGISTER_IXUCA_KERNEL(blackman, INSIGHT_DTYPE_F32, blackman_kernel_gpu);
REGISTER_IXUCA_KERNEL(blackman, INSIGHT_DTYPE_F16, blackman_kernel_gpu);
REGISTER_IXUCA_KERNEL(blackman, INSIGHT_DTYPE_BF16, blackman_kernel_gpu);
