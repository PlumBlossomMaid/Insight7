...
REGISTER_IXUCA_KERNEL(cubic, INSIGHT_DTYPE_F64, cubic_kernel_gpu);
REGISTER_IXUCA_KERNEL(cubic, INSIGHT_DTYPE_F32, cubic_kernel_gpu);
REGISTER_IXUCA_KERNEL(cubic, INSIGHT_DTYPE_F16, cubic_kernel_gpu);
REGISTER_IXUCA_KERNEL(cubic, INSIGHT_DTYPE_BF16, cubic_kernel_gpu);
