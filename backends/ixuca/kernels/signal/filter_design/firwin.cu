...
REGISTER_IXUCA_KERNEL(signal_firwin, INSIGHT_DTYPE_F64,
                         signal_firwin_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_firwin, INSIGHT_DTYPE_F32,
                         signal_firwin_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_firwin, INSIGHT_DTYPE_F16,
                         signal_firwin_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_firwin, INSIGHT_DTYPE_BF16,
                         signal_firwin_kernel_gpu);
