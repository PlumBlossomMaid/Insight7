...
REGISTER_IXUCA_KERNEL(sawtooth, INSIGHT_DTYPE_F64, sawtooth_kernel_gpu);
REGISTER_IXUCA_KERNEL(sawtooth, INSIGHT_DTYPE_F32, sawtooth_kernel_gpu);
REGISTER_IXUCA_KERNEL(sawtooth, INSIGHT_DTYPE_F16, sawtooth_kernel_gpu);
REGISTER_IXUCA_KERNEL(sawtooth, INSIGHT_DTYPE_BF16, sawtooth_kernel_gpu);
