...
REGISTER_IXUCA_KERNEL(chirp, INSIGHT_DTYPE_F64, chirp_kernel_gpu);
REGISTER_IXUCA_KERNEL(chirp, INSIGHT_DTYPE_F32, chirp_kernel_gpu);
REGISTER_IXUCA_KERNEL(chirp, INSIGHT_DTYPE_F16, chirp_kernel_gpu);
REGISTER_IXUCA_KERNEL(chirp, INSIGHT_DTYPE_BF16, chirp_kernel_gpu);
