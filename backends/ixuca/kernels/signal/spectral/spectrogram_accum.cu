...
REGISTER_IXUCA_KERNEL(spectrogram_accum, INSIGHT_DTYPE_C64,
                         spectrogram_accum_kernel_gpu);
REGISTER_IXUCA_KERNEL(spectrogram_accum, INSIGHT_DTYPE_C32,
                         spectrogram_accum_kernel_gpu);
REGISTER_IXUCA_KERNEL(spectrogram_power, INSIGHT_DTYPE_C64,
                         spectrogram_power_kernel_gpu);
REGISTER_IXUCA_KERNEL(spectrogram_power, INSIGHT_DTYPE_C32,
                         spectrogram_power_kernel_gpu);
