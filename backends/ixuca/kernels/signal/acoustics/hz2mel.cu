...
REGISTER_IXUCA_KERNEL(signal_hz2mel, INSIGHT_DTYPE_F64,
                         signal_hz2mel_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_hz2mel, INSIGHT_DTYPE_F32,
                         signal_hz2mel_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_hz2mel, INSIGHT_DTYPE_F16,
                         signal_hz2mel_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_hz2mel, INSIGHT_DTYPE_BF16,
                         signal_hz2mel_kernel_gpu);
