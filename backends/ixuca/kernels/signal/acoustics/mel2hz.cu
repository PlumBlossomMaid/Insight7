...
REGISTER_IXUCA_KERNEL(signal_mel2hz, INSIGHT_DTYPE_F64,
                         signal_mel2hz_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_mel2hz, INSIGHT_DTYPE_F32,
                         signal_mel2hz_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_mel2hz, INSIGHT_DTYPE_F16,
                         signal_mel2hz_kernel_gpu);
REGISTER_IXUCA_KERNEL(signal_mel2hz, INSIGHT_DTYPE_BF16,
                         signal_mel2hz_kernel_gpu);
