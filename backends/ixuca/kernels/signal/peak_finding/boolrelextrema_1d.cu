...
REGISTER_IXUCA_KERNEL(boolrelextrema_1d, INSIGHT_DTYPE_F32,
                         boolrelextrema_1d_kernel_gpu);
REGISTER_IXUCA_KERNEL(boolrelextrema_1d, INSIGHT_DTYPE_F64,
                         boolrelextrema_1d_kernel_gpu);
REGISTER_IXUCA_KERNEL(boolrelextrema_1d, INSIGHT_DTYPE_F16,
                         boolrelextrema_1d_kernel_gpu);
REGISTER_IXUCA_KERNEL(boolrelextrema_1d, INSIGHT_DTYPE_BF16,
                         boolrelextrema_1d_kernel_gpu);
