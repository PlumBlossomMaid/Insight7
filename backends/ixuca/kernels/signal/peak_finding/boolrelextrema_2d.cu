...
REGISTER_IXUCA_KERNEL(boolrelextrema_2d, INSIGHT_DTYPE_F32,
                         boolrelextrema_2d_kernel_gpu);
REGISTER_IXUCA_KERNEL(boolrelextrema_2d, INSIGHT_DTYPE_F64,
                         boolrelextrema_2d_kernel_gpu);
REGISTER_IXUCA_KERNEL(boolrelextrema_2d, INSIGHT_DTYPE_F16,
                         boolrelextrema_2d_kernel_gpu);
REGISTER_IXUCA_KERNEL(boolrelextrema_2d, INSIGHT_DTYPE_BF16,
                         boolrelextrema_2d_kernel_gpu);
