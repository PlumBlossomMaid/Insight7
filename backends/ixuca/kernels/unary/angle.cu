...
REGISTER_IXUCA_KERNEL(angle, INSIGHT_DTYPE_C32, angle_kernel_gpu);
REGISTER_IXUCA_KERNEL(angle, INSIGHT_DTYPE_C64, angle_kernel_gpu);
REGISTER_IXUCA_KERNEL(angle, INSIGHT_DTYPE_F32, angle_kernel_gpu);
REGISTER_IXUCA_KERNEL(angle, INSIGHT_DTYPE_F64, angle_kernel_gpu);
