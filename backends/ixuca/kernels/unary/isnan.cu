...
REGISTER_IXUCA_KERNEL(isnan, INSIGHT_DTYPE_F32, isnan_kernel_gpu);
REGISTER_IXUCA_KERNEL(isnan, INSIGHT_DTYPE_F64, isnan_kernel_gpu);
REGISTER_IXUCA_KERNEL(isnan, INSIGHT_DTYPE_C32, isnan_kernel_gpu);
REGISTER_IXUCA_KERNEL(isnan, INSIGHT_DTYPE_C64, isnan_kernel_gpu);
