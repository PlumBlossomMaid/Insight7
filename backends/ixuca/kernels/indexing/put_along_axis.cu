...
REGISTER_IXUCA_KERNEL(put_along_axis, INSIGHT_DTYPE_F32,
                         put_along_axis_kernel_gpu);
REGISTER_IXUCA_KERNEL(put_along_axis, INSIGHT_DTYPE_F64,
                         put_along_axis_kernel_gpu);
REGISTER_IXUCA_KERNEL(put_along_axis, INSIGHT_DTYPE_I32,
                         put_along_axis_kernel_gpu);
REGISTER_IXUCA_KERNEL(put_along_axis, INSIGHT_DTYPE_I64,
                         put_along_axis_kernel_gpu);
