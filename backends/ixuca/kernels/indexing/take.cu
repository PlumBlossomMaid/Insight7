...
REGISTER_IXUCA_KERNEL(take, INSIGHT_DTYPE_F32, take_kernel_gpu);
REGISTER_IXUCA_KERNEL(take, INSIGHT_DTYPE_F64, take_kernel_gpu);
REGISTER_IXUCA_KERNEL(take, INSIGHT_DTYPE_I32, take_kernel_gpu);
REGISTER_IXUCA_KERNEL(take, INSIGHT_DTYPE_I64, take_kernel_gpu);
