...
REGISTER_IXUCA_KERNEL(unique, INSIGHT_DTYPE_F32, unique_kernel_gpu);
REGISTER_IXUCA_KERNEL(unique, INSIGHT_DTYPE_F64, unique_kernel_gpu);
REGISTER_IXUCA_KERNEL(unique, INSIGHT_DTYPE_I32, unique_kernel_gpu);
REGISTER_IXUCA_KERNEL(unique, INSIGHT_DTYPE_I64, unique_kernel_gpu);
