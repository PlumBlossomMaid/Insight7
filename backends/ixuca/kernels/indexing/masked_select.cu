...
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_BOOL,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_U8,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_I8,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_I16,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_I32,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_I64,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_U16,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_U32,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_U64,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_F16,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_BF16,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_F32,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_F64,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_C32,
                         masked_select_kernel_gpu);
REGISTER_IXUCA_KERNEL(masked_select, INSIGHT_DTYPE_C64,
                         masked_select_kernel_gpu);
