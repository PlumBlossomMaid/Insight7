...
REGISTER_IXUCA_KERNEL(triu, INSIGHT_DTYPE_F32, triu_kernel_gpu);
REGISTER_IXUCA_KERNEL(triu, INSIGHT_DTYPE_F64, triu_kernel_gpu);
REGISTER_IXUCA_KERNEL(triu, INSIGHT_DTYPE_I32, triu_kernel_gpu);
REGISTER_IXUCA_KERNEL(triu, INSIGHT_DTYPE_I64, triu_kernel_gpu);
