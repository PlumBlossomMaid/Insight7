...
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_BOOL, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_U8, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_I8, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_I16, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_I32, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_I64, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_U16, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_U32, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_U64, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_F32, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_F64, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_C32, pad_kernel_gpu);
REGISTER_IXUCA_KERNEL(pad, INSIGHT_DTYPE_C64, pad_kernel_gpu);
