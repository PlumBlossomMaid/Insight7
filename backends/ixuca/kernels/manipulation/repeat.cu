...
REGISTER_IXUCA_KERNEL(repeat, INSIGHT_DTYPE_F32, repeat_kernel_gpu);
REGISTER_IXUCA_KERNEL(repeat, INSIGHT_DTYPE_F64, repeat_kernel_gpu);
REGISTER_IXUCA_KERNEL(repeat, INSIGHT_DTYPE_I32, repeat_kernel_gpu);
REGISTER_IXUCA_KERNEL(repeat, INSIGHT_DTYPE_I64, repeat_kernel_gpu);
