...
REGISTER_IXUCA_KERNEL(tril, INSIGHT_DTYPE_F32, tril_kernel_gpu);
REGISTER_IXUCA_KERNEL(tril, INSIGHT_DTYPE_F64, tril_kernel_gpu);
REGISTER_IXUCA_KERNEL(tril, INSIGHT_DTYPE_I32, tril_kernel_gpu);
REGISTER_IXUCA_KERNEL(tril, INSIGHT_DTYPE_I64, tril_kernel_gpu);
