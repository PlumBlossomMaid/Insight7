...
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_BOOL, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_U8, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_I8, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_I16, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_I32, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_I64, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_U16, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_U32, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_U64, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_F32, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_F64, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_C32, full_kernel_gpu);
REGISTER_IXUCA_KERNEL(full, INSIGHT_DTYPE_C64, full_kernel_gpu);
