...
REGISTER_ILUVATAR_KERNEL(tile, INSIGHT_DTYPE_F32, tile_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(tile, INSIGHT_DTYPE_F64, tile_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(tile, INSIGHT_DTYPE_I32, tile_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(tile, INSIGHT_DTYPE_I64, tile_kernel_gpu);
