...
REGISTER_ILUVATAR_KERNEL(diag, INSIGHT_DTYPE_F32, diag_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(diag, INSIGHT_DTYPE_F64, diag_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(diag, INSIGHT_DTYPE_I32, diag_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(diag, INSIGHT_DTYPE_I64, diag_kernel_gpu);
