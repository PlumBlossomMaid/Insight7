...
REGISTER_ILUVATAR_KERNEL(roll, INSIGHT_DTYPE_F32, roll_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(roll, INSIGHT_DTYPE_F64, roll_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(roll, INSIGHT_DTYPE_I32, roll_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(roll, INSIGHT_DTYPE_I64, roll_kernel_gpu);
