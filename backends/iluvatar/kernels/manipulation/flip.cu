...
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_BOOL, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_U8, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_I8, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_I16, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_I32, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_I64, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_U16, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_U32, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_U64, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_F32, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_F64, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_C32, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_C64, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_F16, flip_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(flip, INSIGHT_DTYPE_BF16, flip_kernel_gpu);
