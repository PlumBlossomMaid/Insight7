...
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_BOOL, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_U8, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_I8, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_I16, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_I32, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_I64, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_U16, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_U32, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_U64, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_F32, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_F64, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_C32, concat_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(concat, INSIGHT_DTYPE_C64, concat_kernel_gpu);
