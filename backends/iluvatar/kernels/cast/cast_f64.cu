// backends/cuda/kernels/cast/cast_f64.cu
/**
 * @file cast_f64.cu
 * @brief CUDA kernel for casting from f64 to all types.
 *
...
REGISTER_ILUVATAR_KERNEL(cast, INSIGHT_DTYPE_F64, cast_f64_kernel_gpu);
