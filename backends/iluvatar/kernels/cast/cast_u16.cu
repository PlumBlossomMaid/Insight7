// backends/cuda/kernels/cast/cast_u16.cu
/**
 * @file cast_u16.cu
 * @brief CUDA kernel for casting from u16 to all types.
 *
...
REGISTER_ILUVATAR_KERNEL(cast, INSIGHT_DTYPE_U16, cast_u16_kernel_gpu);
