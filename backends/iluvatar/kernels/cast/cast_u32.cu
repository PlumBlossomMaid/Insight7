// backends/cuda/kernels/cast/cast_u32.cu
/**
 * @file cast_u32.cu
 * @brief CUDA kernel for casting from u32 to all types.
 *
...
C_Status cast_u32_kernel_gpu(void **inputs, void **outputs) {
  ...
  // Data conversion
  int64_t n = src->numel;
  const uint32_t *src_data = (const uint32_t *)src->data;
...
REGISTER_ILUVATAR_KERNEL(cast, INSIGHT_DTYPE_U32, cast_u32_kernel_gpu);
