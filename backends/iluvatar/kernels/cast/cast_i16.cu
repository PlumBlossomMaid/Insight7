// backends/cuda/kernels/cast/cast_i16.cu
/**
 * @file cast_i16.cu
 * @brief CUDA kernel for casting from i16 to all types.
 *
...
C_Status cast_i16_kernel_gpu(void **inputs, void **outputs) {
  ...
  // Data conversion
  int64_t n = src->numel;
  const int16_t *src_data = (const int16_t *)src->data;
...
REGISTER_ILUVATAR_KERNEL(cast, INSIGHT_DTYPE_I16, cast_i16_kernel_gpu);
