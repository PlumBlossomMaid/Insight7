// backends/cuda/kernels/cast/cast_i8.cu
/**
 * @file cast_i8.cu
 * @brief CUDA kernel for casting from i8 to all types.
 *
...
C_Status cast_i8_kernel_gpu(void **inputs, void **outputs) {
  ...
  // Data conversion
  int64_t n = src->numel;
  const int8_t *src_data = (const int8_t *)src->data;
...
REGISTER_ILUVATAR_KERNEL(cast, INSIGHT_DTYPE_I8, cast_i8_kernel_gpu);
