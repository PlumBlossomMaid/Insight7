...
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_BOOL, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_U8, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_I8, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_I16, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_I32, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_I64, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_U16, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_U32, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_U64, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_F32, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_F64, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_C32, eye_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eye, INSIGHT_DTYPE_C64, eye_kernel_gpu);
