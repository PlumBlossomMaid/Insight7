...
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_I8, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_I16, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_I32, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_I64, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_F32, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_F64, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_C32, abs_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(abs, INSIGHT_DTYPE_C64, abs_kernel_gpu);
