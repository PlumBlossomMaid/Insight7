...
REGISTER_ILUVATAR_KERNEL(quadratic, INSIGHT_DTYPE_F64, quadratic_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(quadratic, INSIGHT_DTYPE_F32, quadratic_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(quadratic, INSIGHT_DTYPE_F16, quadratic_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(quadratic, INSIGHT_DTYPE_BF16, quadratic_kernel_gpu);
