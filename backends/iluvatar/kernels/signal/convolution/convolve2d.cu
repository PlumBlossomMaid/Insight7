...
REGISTER_ILUVATAR_KERNEL(convolve2d, INSIGHT_DTYPE_F32, convolve2d_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(convolve2d, INSIGHT_DTYPE_F64, convolve2d_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(convolve2d, INSIGHT_DTYPE_F16, convolve2d_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(convolve2d, INSIGHT_DTYPE_BF16, convolve2d_kernel_gpu);
