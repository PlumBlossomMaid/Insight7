...
REGISTER_ILUVATAR_KERNEL(convolve1d, INSIGHT_DTYPE_F32, convolve1d_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(convolve1d, INSIGHT_DTYPE_F64, convolve1d_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(convolve1d, INSIGHT_DTYPE_F16, convolve1d_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(convolve1d, INSIGHT_DTYPE_BF16, convolve1d_kernel_gpu);
