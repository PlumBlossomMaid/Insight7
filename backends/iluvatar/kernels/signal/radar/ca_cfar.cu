...
REGISTER_ILUVATAR_KERNEL(ca_cfar, INSIGHT_DTYPE_F32, ca_cfar_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(ca_cfar, INSIGHT_DTYPE_F64, ca_cfar_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(ca_cfar, INSIGHT_DTYPE_F16, ca_cfar_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(ca_cfar, INSIGHT_DTYPE_BF16, ca_cfar_kernel_gpu);
