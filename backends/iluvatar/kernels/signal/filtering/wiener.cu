...
REGISTER_ILUVATAR_KERNEL(signal_wiener, INSIGHT_DTYPE_F64, signal_wiener_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_wiener, INSIGHT_DTYPE_F32, signal_wiener_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_wiener, INSIGHT_DTYPE_F16, signal_wiener_kernel_gpu);
