...
REGISTER_ILUVATAR_KERNEL(signal_hz2bark, INSIGHT_DTYPE_F64,
                    signal_hz2bark_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_hz2bark, INSIGHT_DTYPE_F32,
                    signal_hz2bark_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_hz2bark, INSIGHT_DTYPE_F16,
                    signal_hz2bark_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_hz2bark, INSIGHT_DTYPE_BF16,
                    signal_hz2bark_kernel_gpu);
