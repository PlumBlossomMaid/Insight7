...
REGISTER_ILUVATAR_KERNEL(gausspulse, INSIGHT_DTYPE_F64, gausspulse_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(gausspulse, INSIGHT_DTYPE_F32, gausspulse_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(gausspulse, INSIGHT_DTYPE_F16, gausspulse_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(gausspulse, INSIGHT_DTYPE_BF16, gausspulse_kernel_gpu);
