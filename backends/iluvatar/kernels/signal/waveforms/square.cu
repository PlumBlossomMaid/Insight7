...
REGISTER_ILUVATAR_KERNEL(signal_square, INSIGHT_DTYPE_F64, signal_square_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_square, INSIGHT_DTYPE_F32, signal_square_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(signal_square, INSIGHT_DTYPE_F16, signal_square_kernel_gpu);
