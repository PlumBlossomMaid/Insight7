...
REGISTER_ILUVATAR_KERNEL(gaussian, INSIGHT_DTYPE_F64, gaussian_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(gaussian, INSIGHT_DTYPE_F32, gaussian_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(gaussian, INSIGHT_DTYPE_F16, gaussian_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(gaussian, INSIGHT_DTYPE_BF16, gaussian_kernel_gpu);
