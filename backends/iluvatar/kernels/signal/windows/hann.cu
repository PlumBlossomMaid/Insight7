...
REGISTER_ILUVATAR_KERNEL(hann, INSIGHT_DTYPE_F64, hann_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(hann, INSIGHT_DTYPE_F32, hann_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(hann, INSIGHT_DTYPE_F16, hann_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(hann, INSIGHT_DTYPE_BF16, hann_kernel_gpu);
