...
REGISTER_ILUVATAR_KERNEL(tukey, INSIGHT_DTYPE_F64, tukey_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(tukey, INSIGHT_DTYPE_F32, tukey_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(tukey, INSIGHT_DTYPE_F16, tukey_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(tukey, INSIGHT_DTYPE_BF16, tukey_kernel_gpu);
