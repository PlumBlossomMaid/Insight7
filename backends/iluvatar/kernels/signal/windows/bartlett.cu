...
REGISTER_ILUVATAR_KERNEL(bartlett, INSIGHT_DTYPE_F64, bartlett_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(bartlett, INSIGHT_DTYPE_F32, bartlett_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(bartlett, INSIGHT_DTYPE_F16, bartlett_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(bartlett, INSIGHT_DTYPE_BF16, bartlett_kernel_gpu);
