...
REGISTER_ILUVATAR_KERNEL(cosine, INSIGHT_DTYPE_F64, cosine_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cosine, INSIGHT_DTYPE_F32, cosine_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cosine, INSIGHT_DTYPE_F16, cosine_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cosine, INSIGHT_DTYPE_BF16, cosine_kernel_gpu);
