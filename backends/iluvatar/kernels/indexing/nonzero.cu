...
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_BOOL, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_U8, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_I8, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_I16, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_I32, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_I64, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_U16, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_U32, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_U64, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_F32, nonzero_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nonzero, INSIGHT_DTYPE_F64, nonzero_kernel_gpu);
