...
REGISTER_ILUVATAR_KERNEL(partition, INSIGHT_DTYPE_F32, partition_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(partition, INSIGHT_DTYPE_F64, partition_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(partition, INSIGHT_DTYPE_I32, partition_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(partition, INSIGHT_DTYPE_I64, partition_kernel_gpu);
