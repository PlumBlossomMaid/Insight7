...
REGISTER_ILUVATAR_KERNEL(where, INSIGHT_DTYPE_F32, where_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(where, INSIGHT_DTYPE_F64, where_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(where, INSIGHT_DTYPE_I32, where_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(where, INSIGHT_DTYPE_I64, where_kernel_gpu);
