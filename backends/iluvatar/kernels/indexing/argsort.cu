...
REGISTER_ILUVATAR_KERNEL(argsort, INSIGHT_DTYPE_F32, argsort_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argsort, INSIGHT_DTYPE_F64, argsort_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argsort, INSIGHT_DTYPE_I32, argsort_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argsort, INSIGHT_DTYPE_I64, argsort_kernel_gpu);
