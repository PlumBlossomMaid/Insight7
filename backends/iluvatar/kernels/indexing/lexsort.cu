...
REGISTER_ILUVATAR_KERNEL(lexsort, INSIGHT_DTYPE_F32, lexsort_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lexsort, INSIGHT_DTYPE_F64, lexsort_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lexsort, INSIGHT_DTYPE_I32, lexsort_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lexsort, INSIGHT_DTYPE_I64, lexsort_kernel_gpu);
