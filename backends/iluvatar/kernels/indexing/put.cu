...
REGISTER_ILUVATAR_KERNEL(put, INSIGHT_DTYPE_F32, put_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(put, INSIGHT_DTYPE_F64, put_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(put, INSIGHT_DTYPE_I32, put_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(put, INSIGHT_DTYPE_I64, put_kernel_gpu);
