...
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_F32, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_F64, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_I8, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_I16, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_I32, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_I64, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_U8, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_U16, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_U32, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_U64, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_BOOL, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_C32, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_C64, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_F16, div_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(div, INSIGHT_DTYPE_BF16, div_kernel_gpu);
