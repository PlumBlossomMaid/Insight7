...
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_F32, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_F64, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_I8, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_I16, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_I32, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_I64, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_U8, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_U16, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_U32, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_U64, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_BOOL, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_C32, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_C64, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_F16, mul_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(mul, INSIGHT_DTYPE_BF16, mul_kernel_gpu);
