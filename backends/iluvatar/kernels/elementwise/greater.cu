...
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_F32, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_F64, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_I8, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_I16, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_I32, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_I64, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_U8, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_U16, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_U32, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_U64, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_BOOL, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_C32, greater_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(greater, INSIGHT_DTYPE_C64, greater_kernel_gpu);
