...
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_F32, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_F64, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_I8, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_I16, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_I32, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_I64, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_U8, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_U16, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_U32, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_U64, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_BOOL, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_C32, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_C64, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_F16, add_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(add, INSIGHT_DTYPE_BF16, add_kernel_gpu);
