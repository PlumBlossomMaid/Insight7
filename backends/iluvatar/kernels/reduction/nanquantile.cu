...
REGISTER_ILUVATAR_KERNEL(nanquantile, INSIGHT_DTYPE_F32, nanquantile_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(nanquantile, INSIGHT_DTYPE_F64, nanquantile_kernel_gpu);
