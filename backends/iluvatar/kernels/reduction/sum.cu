...
REGISTER_ILUVATAR_KERNEL(sum, INSIGHT_DTYPE_F32, sum_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(sum, INSIGHT_DTYPE_F64, sum_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(sum, INSIGHT_DTYPE_I32, sum_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(sum, INSIGHT_DTYPE_I64, sum_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(sum, INSIGHT_DTYPE_C32, sum_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(sum, INSIGHT_DTYPE_C64, sum_kernel_gpu);
