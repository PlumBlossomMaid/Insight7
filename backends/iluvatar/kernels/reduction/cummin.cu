...
REGISTER_ILUVATAR_KERNEL(cummin, INSIGHT_DTYPE_F32, cummin_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cummin, INSIGHT_DTYPE_F64, cummin_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cummin, INSIGHT_DTYPE_I32, cummin_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cummin, INSIGHT_DTYPE_I64, cummin_kernel_gpu);
