...
REGISTER_ILUVATAR_KERNEL(any, INSIGHT_DTYPE_BOOL, any_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(any, INSIGHT_DTYPE_F32, any_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(any, INSIGHT_DTYPE_F64, any_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(any, INSIGHT_DTYPE_I32, any_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(any, INSIGHT_DTYPE_I64, any_kernel_gpu);
