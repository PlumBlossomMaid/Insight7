...
REGISTER_ILUVATAR_KERNEL(argmin, INSIGHT_DTYPE_F32, argmin_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argmin, INSIGHT_DTYPE_F64, argmin_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argmin, INSIGHT_DTYPE_I32, argmin_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argmin, INSIGHT_DTYPE_I64, argmin_kernel_gpu);
