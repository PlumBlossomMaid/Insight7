...
REGISTER_ILUVATAR_KERNEL(cumprod, INSIGHT_DTYPE_F32, cumprod_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cumprod, INSIGHT_DTYPE_F64, cumprod_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cumprod, INSIGHT_DTYPE_I32, cumprod_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cumprod, INSIGHT_DTYPE_I64, cumprod_kernel_gpu);
