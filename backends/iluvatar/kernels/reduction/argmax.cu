...
REGISTER_ILUVATAR_KERNEL(argmax, INSIGHT_DTYPE_F32, argmax_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argmax, INSIGHT_DTYPE_F64, argmax_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argmax, INSIGHT_DTYPE_I32, argmax_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(argmax, INSIGHT_DTYPE_I64, argmax_kernel_gpu);
