...
REGISTER_ILUVATAR_KERNEL(all, INSIGHT_DTYPE_BOOL, all_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(all, INSIGHT_DTYPE_F32, all_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(all, INSIGHT_DTYPE_F64, all_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(all, INSIGHT_DTYPE_I32, all_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(all, INSIGHT_DTYPE_I64, all_kernel_gpu);
