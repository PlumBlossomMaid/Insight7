...
REGISTER_ILUVATAR_KERNEL(prod, INSIGHT_DTYPE_F32, prod_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(prod, INSIGHT_DTYPE_F64, prod_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(prod, INSIGHT_DTYPE_I32, prod_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(prod, INSIGHT_DTYPE_I64, prod_kernel_gpu);
