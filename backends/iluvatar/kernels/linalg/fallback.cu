...
REGISTER_ILUVATAR_KERNEL(cholesky, INSIGHT_DTYPE_F32, cholesky_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cholesky, INSIGHT_DTYPE_F64, cholesky_kernel_gpu);
...
REGISTER_ILUVATAR_KERNEL(qr, INSIGHT_DTYPE_F32, qr_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(qr, INSIGHT_DTYPE_F64, qr_kernel_gpu);

// LQ decomposition: depends on QR of transpose
static C_Status lq_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(lq, INSIGHT_DTYPE_F32, lq_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lq, INSIGHT_DTYPE_F64, lq_kernel_gpu);

// LU decomposition: complex row-major ↔ column-major conversion
static C_Status lu_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(lu, INSIGHT_DTYPE_F32, lu_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lu, INSIGHT_DTYPE_F64, lu_kernel_gpu);

// LU unpack: depends on LU
static C_Status lu_unpack_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(lu_unpack, INSIGHT_DTYPE_F32, lu_unpack_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lu_unpack, INSIGHT_DTYPE_F64, lu_unpack_kernel_gpu);

// cond: requires norm + inv, matrix 1-norm/inf-norm not on GPU
static C_Status cond_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(cond, INSIGHT_DTYPE_F32, cond_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cond, INSIGHT_DTYPE_F64, cond_kernel_gpu);
...
REGISTER_ILUVATAR_KERNEL(pinv, INSIGHT_DTYPE_F32, pinv_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(pinv, INSIGHT_DTYPE_F64, pinv_kernel_gpu);

// lstsq: requires gels or SVD
static C_Status lstsq_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(lstsq, INSIGHT_DTYPE_F32, lstsq_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(lstsq, INSIGHT_DTYPE_F64, lstsq_kernel_gpu);

// eig: general eigenvalue, requires complex types
static C_Status eig_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(eig, INSIGHT_DTYPE_F32, eig_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eig, INSIGHT_DTYPE_F64, eig_kernel_gpu);

// eigvals: general eigenvalues only
static C_Status eigvals_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(eigvals, INSIGHT_DTYPE_F32, eigvals_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(eigvals, INSIGHT_DTYPE_F64, eigvals_kernel_gpu);

// cov: uses mean + matmul, composed of other ops
static C_Status cov_kernel_gpu(void **inputs, void **outputs) {
  return C_FALLBACK;
}
REGISTER_ILUVATAR_KERNEL(cov, INSIGHT_DTYPE_F32, cov_kernel_gpu);
REGISTER_ILUVATAR_KERNEL(cov, INSIGHT_DTYPE_F64, cov_kernel_gpu);
